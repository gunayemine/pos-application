                ...
                <tbody>
                  <tr className="border-b border-t border-slate-200">
                    <td className="py-4 sm:table-cell hidden">
                      <img
                        src="https://static.ticimax.cloud/30771/uploads/urunresimleri/elma-starking-kg-13da.jpg"
                        alt=""
                ...
                <tfoot>
                  <tr>
                    ...
                    <th className="text-right pt-6" colSpan="4" scope="row">
                      <span className="font-normal text-slate-700">60₺</span>
                    </th>
                  </tr>
                  <tr>
                    <th
                    ...
                    <th className="text-right pt-6" colSpan="4" scope="row">
                      <span className="font-normal text-red-600">+8.92₺</span>
                    </th>
                  </tr>
                  <tr>
                    <th
                    ...
                    <th className="text-left pt-4 sm:hidden" scope="row">
                      <p className="font-normal text-slate-700">Toplam Tutar</p>
                    </th>
